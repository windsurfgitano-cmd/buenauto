...
export function CotizarClient({
  ...
  if (done) {
    return (
      <div className="turbo-scope min-h-dvh bg-carbon px-4 py-16">
        <div className="mx-auto max-w-lg text-center">
          ...
          <div className="mt-6 flex justify-center gap-3">
            <Link href="/descubre" className="rounded-xl bg-racing px-5 py-3 font-bold text-white hover:bg-racing-bright">
              Seguir explorando
            </Link>
            <Link href="/favoritos" className="rounded-xl border border-edge px-5 py-3 font-bold text-paper hover:border-mutedwhite">
              Mis favoritos
            </Link>
          </div>
        </div>
    ...
    <div className="turbo-scope min-h-dvh bg-carbon px-4 py-8">
      <div className="mx-auto max-w-2xl">
        <div className="flex items-center justify-between">
          <Link href="/descubre" className="text-sm text-mutedwhite hover:text-paper">
            ← Volver al feed
          </Link>
        ...
        {/* Resumen del auto */}
        <div className="mt-3 flex items-center gap-4 rounded-2xl border border-edge bg-carbon-2 p-4">
